...
object EnronAnalysis {
  ...
  /* Compute an inverted index of the set of articles, mapping each keyword
   * to the Enron email in which it occurs.
   */
  ...
  def main(args: Array[String]) {
    ...
    val topicRanked2: List[(String, Int)] = timed("Ranking using inverted inxed and reduceByKey", rankKeywordsReduceByKey(topic1, enronRdd))
